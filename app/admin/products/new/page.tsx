    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 p-6">
      <div className="container mx-auto max-w-4xl">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-3xl font-bold text-orange-800">Add New Product to Menu</h1>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-2 border-dashed border-orange-200 rounded-xl p-6">
              <div className="flex flex-col items-center justify-center">
                ...
                <input
                  ...
                  className="w-full max-w-md px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                  placeholder="https://example.com/image.jpg"
                />
                <p className="text-xs text-gray-500 mt-2">
                  Enter a URL for your product image (e.g., from Unsplash, Imgur, or your own hosting)
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-orange-50 rounded-lg">
              ...
              <label htmlFor="is_available" className="text-sm font-medium text-gray-700">
                Available for ordering (customers can see and order this item)
              </label>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Preview (how customers will see it)</h2>
          <div className="max-w-sm mx-auto">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-orange-100">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-500 mb-3">{formData.description || "Product description will appear here"}</p>
